...
const HF_PLAYER = (() => {
  ...
  const messages = (s) => {
    const threads = [
      {
        name: "Coach Darko",
        msg: "Great session today. Keep pushing on that left foot.",
        time: "2h",
        color: "#C9961A",
        unread: 1,
      },
      {
        name: "HappyFeet Scout",
        msg: "Trial opportunity. Check this out when you can.",
        time: "1d",
        color: "#185FA5",
        unread: 1,
      },
      {
        name: "Abena Sarpong",
        msg: "Coming to practice tomorrow?",
        time: "2d",
        color: "#1a7a2e",
        unread: 1,
      },
